            ...
            <div className="card p-4 shadow-sm chat1">
                <form onSubmit={handleSubmit}>
                    <div className="mb-3">
                        ...
                        <input type="text" className="form-control" id="nom" placeholder="Entrez votre nom" value={nom} onChange={(e) => setNom(e.target.value)} required readOnly/>
                    </div>
                    <div className="mb-3">
            ...
            <ul className="list-group chat2">
                ...
                <li key={discussion.id} className="d-block justify-content-start m1">
                    <div className="c2" style={discussion.nom === 'Clinique "LES EAUX"' ? { background: '#13da66', color: 'white' } : {}}>
                        ...
                        <button onClick={() => handleEdit(discussion)} className="btn btn-sm btn-warning me-2">Modifier</button>
                        <button onClick={() => handleDelete(discussion.id)} className="btn btn-sm btn-danger">Supprimer</button>
                    </div>
                </li>
            ))}
            </ul>    
